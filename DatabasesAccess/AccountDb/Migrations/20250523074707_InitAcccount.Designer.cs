...
namespace DatabasesAccess.Migrations
{
    ...
    [Migration("20250523074707_InitAcccount")]
    partial class InitAcccount
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DatabaseModels.AccountDatabaseModels.User", b =>
                {
                    ...
                    b.HasIndex(new[] { "Email", "HashedPassword" }, "ix_user_email_hashed_password")
                        .IsUnique();

                    b.HasIndex(new[] { "PhoneNumber", "HashedPassword" }, "ix_user_phone_number_hashed_password")
                        .IsUnique();
